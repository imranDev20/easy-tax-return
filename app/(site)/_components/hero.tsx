      ...
      <div className="flex max-w-6xl mx-auto ">
        <div className="flex justify-center items-center">
          <div>
            ...
            <Button className="mt-8 bg-[#0074D9] rounded-none">Discover</Button>
          </div>
        </div>
        <div className="relative mt-8">
          <Image className=" rounded-t-full" src={heroImage} alt="hero-image" />
          <div className="absolute top-4 left-4 bg-[#EBBDBD] text-[#513B3B] px-2 py-1 rounded-md">
            Tax Advice
          </div>
          <div className="absolute top-32 -right-8 bg-[#A8F1E5] text-teal-600 px-2 py-1 rounded-md">
            Legal Advice
          </div>
          <div className="absolute bottom-4 -left-10 bg-[#F1EFA8] text-[#535237] px-2 py-1 rounded-md">
            Financial Advice
          </div>
        </div>
      </div>
