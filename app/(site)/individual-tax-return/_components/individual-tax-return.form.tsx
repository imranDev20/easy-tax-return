...
const IndividualTaxReturnForm: React.FC = () => {
  ...
  const formFields: FormField[] = [
    ...
    },
    {
      ...
      onBlur(event) {
        setValue(
          "houseRentAllowanceGovtEmployment.taxExempted",
          event.target.value
        );
      },
    },
    ...
    },
    {
      ...
      onBlur(event) {
        setValue(
          "medicalAllowanceGovtEmployment.taxExempted",
          event.target.value
        );
      },
    },
    ...
    },
    {
      ...
      onBlur(event) {
        setValue(
          "conveyanceAllowanceGovtEmployment.taxExempted",
          event.target.value
        );
      },
    },
    ...
    },
    {
      ...
      onBlur(event) {
        setValue(
          "festivalAllowanceGovtEmployment.taxable",
          event.target.value
        );
      },
...

    {
      ...
      onBlur(event) {
        setValue(
          "allowanceForSupportStaffGovtEmployment.taxExempted",
          event.target.value
        );
      },
    },
    ...
    },
    {
      ...
      onBlur(event) {
        setValue(
          "leaveAllowanceGovtEmployment.taxExempted",
          event.target.value
        );
      },
    },
    ...
    },
    {
      ...
      onBlur(event) {
        setValue(
          "honorariumRewardGovtEmployment.taxExempted",
          event.target.value
        );
      },
    },
    ...
    },
    {
      ...
      onBlur(event) {
        setValue(
          "overtimeAllowanceGovtEmployment.taxExempted",
          event.target.value
        );
      },
    },
    ...
    },
    {
      ...
      onBlur(event) {
        setValue(
          "banglaNoboborshoAllowancesGovtEmployment.taxExempted",
          event.target.value
        );
      },
    },
    ...
    },
    {
      ...
      onBlur(event) {
        setValue(
          "lumpGrantGovtEmployment.taxExempted",
          event.target.value
        );
      },
    },
    ...
    },
    {
      ...
      onBlur(event) {
        setValue(
          "gratuityGovtEmployment.taxExempted",
          event.target.value
        );
      },
    },
    ...
    },
    {
      ...
      onBlur(event) {
        setValue(
          "otherAllowanceGovtEmployment.taxable",
          event.target.value
        );
      },
    },
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Vehicle above to 2500 cc", value: "Vehicle above to 2500 cc" },       
      ],
      x: 330,
      y: 805,
      width: 290,
